...
class StartVM @Inject constructor(private val accountApiService: AccountApiService) : ViewModel() {
    ...
    fun authorizeUser(token: String) {
        ...
        val tokenCall = accountApiService.authorizeUser("AwesomeToken $token")
